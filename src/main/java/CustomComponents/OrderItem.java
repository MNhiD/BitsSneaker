...
//        setPreferredSize(new Dimension(950, 100));
        ...
        JLabel sellID = new JLabel("Mã đơn: "+order.getSellID());
        ...
        JLabel amount = new JLabel("Số lượng: "+order.getAmount());
...
//        JLabel price = new JLabel("Đơn giá: "+order.getPrice()+"");
        JLabel price = new JLabel("Đơn giá: "+FormatText.covertCurrentcyFormat(order.getPrice()));
